...
type OrdererCallbacks struct {
	ApplyAtropos func(decidedFrame consensustypes.Frame, atropos consensustypes.EventHash) (sealEpoch *consensustypes.Validators)

	EpochDBLoaded func(consensustypes.Epoch)
}
