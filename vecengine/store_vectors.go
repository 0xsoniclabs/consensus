...
func (vi *Engine) GetLowestAfter(id hash.EventHash) *LowestAfterSeq {
...
func (vi *Engine) GetHighestBefore(id hash.EventHash) *HighestBeforeSeq {
...
func (vi *Engine) SetLowestAfter(id hash.EventHash, seq *LowestAfterSeq) {
...
func (vi *Engine) SetHighestBefore(id hash.EventHash, seq *HighestBeforeSeq) {
